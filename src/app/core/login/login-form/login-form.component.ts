  ...
  <div class="form-group">
    <form [formGroup]="loginForm" (ngSubmit)="onSubmit()">
        <div class="mt-3">
            ...
            <input type="email" class="form-control" id="Item" placeholder="Enter item" formControlName="email" required="true">
        ...
        <div class="mt-3">
            ...
            <input type="password" class="form-control" id="Id" placeholder="Enter id" formControlName="password">
